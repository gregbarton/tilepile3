...
public class StationFactory {
    ...
    public static final String getDefaultName(GraphicsConfiguration gc) {
        ...
        return 
            TilepileUtils.getNormalizedName(TilepileUtils.getDefaultLocalAddress().getHostAddress()) +
            TilepileUtils.getNormalizedName(gc.getDevice().getIDstring());
    }
    ...
    public static final Station make(DataManagerRemote dataManager, GraphicsConfiguration gc, int number) throws RemoteException {
        ...
        return 
            new Station(
                ...
                color,
                number,
                StationRemote.REMOTE_NAME + TilepileUtils.getNormalizedName(gc.getDevice().getIDstring())
            );
    }
}
