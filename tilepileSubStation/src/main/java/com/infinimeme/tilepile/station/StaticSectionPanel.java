...
*.
    ...
    public DynamicSectionPanel makeDynamic() {
        return new DynamicSectionPanel(getSection(), getPalette(), isWithGrid(), getState(), getGraphicsConfiguration());
    }
    ...
    private VolatileImage getAllImage() throws TilepileException {
        ...
        if (isShowNumbers()) {
            ...
            if (allImageNum == null) {
                ...
                allImage = graphicsConfiguration.createCompatibleVolatileImage(
                    staticBounds.width,
                    staticBounds.height);
                
                allImage.setAccelerationPriority(1f);
                
                Graphics2D graphics = ((VolatileImage) allImageNum).createGraphics();
            ...
            if (allImage == null) {
                ...
                Graphics2D graphics = ((VolatileImage) allImage).createGraphics();
                drawAll(graphics, staticBounds);
                graphics.dispose();
            }
    ...
    private VolatileImage getWorkingImage() throws TilepileException {
        ...
        if (isShowNumbers()) {
            ...
            if (workingImageNum == null) {
                ...
                workingImage = graphicsConfiguration.createCompatibleVolatileImage(
                    staticBounds.width,
                    staticBounds.height);
                
                workingImage.setAccelerationPriority(1f);
                
                Graphics2D graphics = ((VolatileImage) workingImageNum).createGraphics();
                drawAll(graphics, staticBounds);
                graphics.dispose();
            ...
            if (workingImage == null) {
                ...
                Graphics2D graphics = ((VolatileImage) workingImage).createGraphics();
                drawAll(graphics, staticBounds);
                graphics.dispose();
            }
