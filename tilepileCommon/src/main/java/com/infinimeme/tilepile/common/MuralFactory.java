...
public class MuralFactory {
     ...
     **/
    public static final Mural make(String name, int gridWidth, int gridHeight,
                                   BufferedImage originalImage, Palette palette, boolean useBackupColors)
                            throws IOException, 
                                   TilepileException {
     ...
     **/
    public static final Mural make(String name, int gridWidth, int gridHeight, File dataFile, Palette palette)
                            throws IOException {
