...
public class Server {
    ...
    public static void main(String[] args) throws TilepileException {
        ...
        try {
            ...
            TilepileUtils.getRegistry().rebind(
                remoteName,
                DataManager.getInstance());

            DataManagerDiscovery
                .startDiscoveryServer(DataManager.getInstance());
